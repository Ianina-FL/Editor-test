    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Categories branches</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {branches.categories_branches &&
                      Array.isArray(branches.categories_branches) &&
                      branches.categories_branches.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
              ...
              {!branches?.categories_branches?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
